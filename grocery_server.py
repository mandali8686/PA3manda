...
class GroceryOrder ():
  ...
  def initialize (self, args):
    ...
    try:
      ...
      self.grocery_obj.initialize (config, args.addr, args.port, args.demux_token)
  ...
  def driver (self):
    try:
      ...
      while True:
        ...
        if str(request.msg_type) == "MessageTypes.GROCERY":
          resp = self.gen_response_msg (1, "Order Placed!")
        else:
